...
enum GV_ChunkType : uint32_t
{
    ...
    GV_CHUNK_AREA_TRIGGER_BOX = 0x0012,
    ...
    GV_CHUNK_AUDIO_SOURCE = 0x0035,
    GV_CHUNK_WORLD_STATE = 0x0036,
    GV_CHUNK_PLAYER_STATE = 0x0037,
    GV_CHUNK_NPC_STATE = 0x0039,
    GV_CHUNK_LOCAL_STATE = 0x0038,
    GV_CHUNK_BUTTON = 0x0040,
    GV_CHUNK_TERRAIN_ATLAS = 0x0041,
    GV_CHUNK_CROSSHAIR = 0x0042,
    GV_CHUNK_MESSAGE_RELAY = 0x0043,
    GV_CHUNK_ZONE_TRIGGER = 0x0044,
    GV_CHUNK_SCROLLING_MAP = 0x0045,
