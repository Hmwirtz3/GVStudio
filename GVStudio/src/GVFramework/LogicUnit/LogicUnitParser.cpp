...
static GV_ChunkType ParseChunkType(const std::string& s)
{
    static const std::unordered_map<std::string, GV_ChunkType> map =
    {
        ...
        { "GV_CHUNK_DYNAMIC_LIGHT", GV_CHUNK_DYNAMIC_LIGHT },
        { "GV_CHUNK_BAKED_LIGHT", GV_CHUNK_BAKED_LIGHT },
        { "GV_CHUNK_AREA_TRIGGER_BOX", GV_CHUNK_AREA_TRIGGER_BOX },
        { "GV_CHUNK_CONTROLLER", GV_CHUNK_CONTROLLER },
        ...
        { "GV_CHUNK_AUDIO_SOURCE", GV_CHUNK_AUDIO_SOURCE},
        {"GV_CHUNK_WORLD_STATE", GV_CHUNK_WORLD_STATE},
        {"GV_CHUNK_PLAYER_STATE", GV_CHUNK_PLAYER_STATE},
        {"GV_CHUNK_NPC_STATE", GV_CHUNK_NPC_STATE},
        {"GV_CHUNK_LOCAL_STATE", GV_CHUNK_LOCAL_STATE},
        {"GV_CHUNK_BUTTON", GV_CHUNK_BUTTON},
        {"GV_CHUNK_TERRAIN_ATLAS", GV_CHUNK_TERRAIN_ATLAS},
        {"GV_CHUNK_CROSSHAIR", GV_CHUNK_CROSSHAIR },
        {"GV_CHUNK_MESSAGE_RELAY", GV_CHUNK_MESSAGE_RELAY},
        {"GV_CHUNK_ZONE_TRIGGER", GV_CHUNK_ZONE_TRIGGER},
        {"GV_CHUNK_SCROLLING_MAP", GV_CHUNK_SCROLLING_MAP},
